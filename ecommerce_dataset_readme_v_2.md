...
## 🖋️ Update (v2) — Multi-Order Version (November 2025)

A new file has been added: **`ecommerce_customer_behavior_dataset_v2.csv`**

This version simulates multiple orders per customer, making the dataset suitable for **RFM segmentation**, **CLV analysis**, and other **behavioral clustering** studies.
...
📌 *The original single-order dataset (`ecommerce_customer_behavior_dataset.csv`) remains unchanged for backward compatibility.*
